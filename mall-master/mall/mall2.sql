...
CREATE TABLE `mall_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100031 DEFAULT CHARSET=utf8 COMMENT='1,  先查出1级目录  -》  查其子目录，一直查到的是null\r\n2， 查出目录  -》 查父目录  ，一直查到parent_id=0';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='支付信息表   order_no唯一约束   不能重复\r\nCURRENT_TIMESTAMP 默认当前时间';
